...
public class EmpDeptSalgradeTests
{
    ...
    public void ShouldSelectNamesAndSalaries()
    {
        ...
        var result = emps.Select(e => new { e.EName, Sal = e.Sal }).ToList();
    ...
    public void ShouldJoinEmployeesWithDepartments()
    {
        ...
        var result  = (from e in emps
            ...
            select new { EName = e.EName, DName = d.DName }).ToList();
    ...
    public void ShouldCountEmployeesPerDepartment()
    {
        ...
        var result = (from e in emps group e by e.DeptNo into g select new { DeptNo = g.Key, Count = g.Count() }).ToList();
    ...
    public void ShouldReturnEmployeesWithCommission()
    {
        ...
        var result = (from e in emps where e.Comm != null 
            select new { Ename =e.EName, Comm = e.Comm}); 
    ...
    public void ShouldMatchEmployeeToSalaryGrade()
    {
        ...
        var result = (from e in emps from s in grades where e.Sal >= s.Losal &&
                                                            e.Sal <= s.Hisal select new {EName = e .EName,Grade = s.Grade}).ToList();
    ...
    public void ShouldCalculateAverageSalaryPerDept()
    {
        ...
        var result = (from e in emps group e by e.DeptNo into g select  new
        {
            DeptNo = g.Key,
    ...
    public void ShouldReturnEmployeesEarningMoreThanDeptAverage()
    {
        ...
        var result = (from e in emps where e.Sal > (from e2 in emps where e2.DeptNo == e.DeptNo
            select e2.Sal).Average() select e.EName).ToList();
