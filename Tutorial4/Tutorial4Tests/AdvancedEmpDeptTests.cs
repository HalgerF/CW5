...
public class AdvancedEmpDeptTests
{
    ...
    public void ShouldReturnEmployeesWithManagers()
    {
        ...
        var withMgr = from e in emps where e.Mgr != null select e; 
    ...
    public void ShouldReturnEmployeeManagerPairs()
    {
        ...
        var result = from e1 in emps join e2 in emps on e1.Mgr 
            equals e2.EmpNo select new {Employee = e1.EName, Manager = e2.EName};
    ...
    public void ShouldReturnTotalIncomeIncludingCommission()
    {
        ...
        var result = (from e in emps select new {EName =e.EName, Total = e.Sal + e.Comm}).ToList();
    ...
    public void ShouldJoinEmpDeptSalgrade()
    {
        ...
        var result = (from e in emps
            ...
            from s in grades
            where e.Sal >= s.Losal && e.Sal <= s.Hisal select new {EName = e.EName, DName = d.DName, Grade = s.Grade}); 
